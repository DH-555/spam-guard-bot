const STRINGS = {
  en: {
    ...
    setup: {
      ...
      analyticsTitle: "Global anonymous spam analytics",
      analyticsScope: "Scope: all servers where the bot is installed.",
  ...
  es: {
    ...
    setup: {
      ...
      analyticsTitle: "Estadísticas globales y anónimas de spam",
      analyticsScope: "Ámbito: todos los servidores donde está instalado el bot.",
