const STRINGS = {
  en: {
    ...
    setup: {
      ...
      botDetectionSaved: (enabled) => `Bot message detection is now ${enabled ? "enabled" : "disabled"}.`,
      currentBotDetection: (enabled) => `Bot message detection: ${enabled ? "enabled" : "disabled"}.`,
  ...
  es: {
    ...
    setup: {
      ...
      botDetectionSaved: (enabled) => `La detección de mensajes de bots está ${enabled ? "activada" : "desactivada"}.`,
      currentBotDetection: (enabled) => `Detección de mensajes de bots: ${enabled ? "activada" : "desactivada"}.`,
